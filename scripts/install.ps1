...
$GitHubRepo = "kilometers-ai/kilometers"
...
function Download-Binary {
    ...
    try {
        ...
        Write-Warn "CDN download failed, trying GitHub releases..."
        $githubUrl = "https://github.com/$GitHubRepo/releases/latest/download/$binaryFile"
        try {
