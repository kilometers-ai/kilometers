            ...
            modelBuilder.Entity("Kilometers.Api.Infrastructure.EventStore.EventEntity", b =>
                {
                    ...
                    b.Property<string>("CustomerApiKeyHash")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.HasIndex("CustomerApiKeyHash", "Direction")
                        .HasDatabaseName("idx_customer_direction");

                    b.HasIndex("CustomerApiKeyHash", "Method")
                        .HasDatabaseName("idx_customer_method");

                    b.HasIndex("CustomerApiKeyHash", "Timestamp")
